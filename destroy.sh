...
echo -e "$(prefix)$YELLOW [$FrontendStack] Deletion in progress.$ENDCOLOR\n"
...
echo -e "\n$(prefix)$GREEN [$FrontendStack] ✅ Deleted.$ENDCOLOR\n"

# Delete BackendStack
echo -e "$(prefix)$YELLOW [$BackendStack] Deletion in progress.$ENDCOLOR\n"
...
echo -e "\n$(prefix)$GREEN [$BackendStack] ✅ Deleted.$ENDCOLOR\n"

# Delete SmilePipeline
echo -e "$(prefix)$YELLOW [$StackName Stack] Deletion in progress.$ENDCOLOR\n"
...
echo -e "\n$(prefix)$GREEN [$StackName Stack] ✅ Deleted. $ENDCOLOR\n"